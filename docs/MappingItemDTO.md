...
**sourceField** | **string** |  | [optional] [default to undefined]
**targetObject** | [**CaraerObjectDTO**](CaraerObjectDTO.md) |  | [optional] [default to undefined]
**targetProperty** | [**PropertyDTO**](PropertyDTO.md) |  | [optional] [default to undefined]
**conversionFunction** | **string** |  | [optional] [default to undefined]

## Example

```typescript
import { MappingItemDTO } from '@caraer/client';

const instance: MappingItemDTO = {
    uuid,
    name,
    label,
    createdAt,
